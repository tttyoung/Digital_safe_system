...
HD_PWD='C:/Users/sonhu/DigitalSafeSystem/DigitalSafeSystem/DigitalSafeSystem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log output_test_driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source output_test_driver.tcl -notrace
