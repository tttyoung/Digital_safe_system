...
HD_PWD='C:/Users/sonhu/DigitalSafeSystem/DigitalSafeSystem/DigitalSafeSystem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log output_test_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source output_test_driver.tcl
